...
weather_control_frame.grid(column=0, row=0, padx=8, pady=4)

# Adding Label to widget:
ttk.Label(weather_control_frame, text='Location').grid(column=0, row=0, sticky='W')

# Creating ComboBox:
city = tk.StringVar()
citySelected = ttk.Combobox(weather_control_frame, width=12, textvariable=city)
